const messages = {
    ...
    aiThreatModeler: {
        ...
        apiKeyOverrideGemini: 'Optional: Custom Gemini API Key',
        apiKeyOverrideBedrock: 'Optional: Custom Bedrock Mantle API Key',
        apiKeyPlaceholderGemini: 'Enter custom Gemini API key if not configured on server...',
        apiKeyPlaceholderBedrock: 'Enter custom Bedrock Mantle API key if not configured on server...',
        aiProvider: 'AI Provider',
        baseUrl: 'Base URL (OpenAI Compatible Endpoint)',
        modelName: 'Model Name',
        extendedThinking: 'Enable Extended Thinking (Claude 3.7+ / Reasoning Models)',
