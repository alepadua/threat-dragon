const messages = {
    ...
    dashboard: {
        ...
        actions: {
            ...
            aiThreatModeler: 'Gerar Modelo de Ameaças usando Agente de IA'
        }
    },
    aiThreatModeler: {
        title: 'Modelador de Ameaças com Agente de IA',
        description: 'Envie a documentação da arquitetura do sistema e as imagens dos diagramas de rede. O agente de IA irá analisá-los, mapear a arquitetura, realizar a modelagem de ameaças STRIDE e gerar um diagrama do Threat Dragon para você.',
        formTitle: 'Título do Modelo de Ameaça',
        formDescription: 'Descrição do Sistema',
        formDocs: 'Arquivos de Documentação (TXT, MD, DOCX, PDF)',
        formImages: 'Diagramas de Arquitetura / Imagens (PNG, JPG, WEBP)',
        apiKeyOverrideGemini: 'Opcional: Chave de API Personalizada do Gemini',
        apiKeyOverrideBedrock: 'Opcional: Chave de API Personalizada do Bedrock Mantle',
        apiKeyPlaceholderGemini: 'Insira a chave de API personalizada se não estiver configurada no servidor...',
        apiKeyPlaceholderBedrock: 'Insira a chave de API personalizada se não estiver configurada no servidor...',
        ...
        generateBtn: 'Gerar Modelo de Ameaça com IA',
        generating: 'Gerando Modelo de Ameaças...',
        dropFiles: 'Arraste e solte arquivos aqui ou clique para selecionar',
        successTitle: 'Modelo de Ameaça Gerado!',
        successSubtitle: 'O agente de IA mapeou com sucesso sua arquitetura e identificou as ameaças.',
        statsElements: 'Componentes Criados',
        statsThreats: 'Ameaças STRIDE Identificadas',
        ...
        questionProgress: 'Progresso das Perguntas',
        questionsRemaining: 'perguntas restantes para concluir a estrutura',
        estimatedRounds: 'Rodadas de Refinamento Estimadas',
        questionsAnswered: 'respondidas',
        categoryProgress: 'Cobertura da Categoria'
    },
    demo: {
