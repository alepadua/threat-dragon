const messages = {
    ...
    dashboard: {
        ...
        actions: {
            ...
            aiThreatModeler: 'Gerar Modelo de Ameaças com Agente de IA'
        }
    },
    aiThreatModeler: {
        title: 'Modelador de Ameaças com Agente de IA',
        description: 'Carregue a documentação da arquitetura do sistema e as imagens dos diagramas de rede. O agente de IA irá analisá-los, mapear a arquitetura, realizar a modelação de ameaças STRIDE e gerar um diagrama do Threat Dragon para si.',
        formTitle: 'Título do Modelo de Ameaças',
        formDescription: 'Descrição do Sistema',
        formDocs: 'Ficheiros de Documentação (TXT, MD, DOCX, PDF)',
        ...
        successTitle: 'Modelo de Ameaças Gerado!',
        successSubtitle: 'O agente de IA mapeou com sucesso a sua arquitetura e identificou as ameaças.',
        ...
        downloadJson: 'Descarregar JSON do Modelo',
        downloadSummaryPdf: 'Descarregar Relatório PDF Resumido',
        ...
        estimatedRounds: 'Rondas de Refinamento Estimadas',
